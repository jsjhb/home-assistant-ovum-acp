...
from .const import DEFAULT_NAME, DEFAULT_PORT, DEFAULT_UNIT, DEFAULT_SCAN_INTERVAL, DOMAIN
    ...
    async def async_step_init(self, user_input=None):
        ...
        if user_input is not None:
            try:
                ...
                await hub.update_connection_settings(user_input[CONF_HOST], user_input[CONF_PORT], user_input[CONF_UNIT], user_input[CONF_SCAN_INTERVAL])
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required(CONF_UNIT, default=self.config_entry.data.get(CONF_UNIT, 247)): int,
